...
$query = 'SELECT customers.customerID, customers.emailAddress, customers.firstName, customers.lastName, addresses.line1, addresses.city, addresses.state, addresses.zipCode, addresses.phone from customers INNER JOIN addresses on customers.customerID = addresses.customerID';
